    ...
    return (
        <>
            <header data-bs-theme="dark">
                ...
                <div className="navbar shadow-sm" style={{ background: "#191970"}}>
                    <div className="container">
                        <a href="/" className="navbar-brand d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-flower3" viewBox="0 0 16 16">
                            ...
                            <strong>Dreaming Flowers</strong>
                        </a>
                        <button
